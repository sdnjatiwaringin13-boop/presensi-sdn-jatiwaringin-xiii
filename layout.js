...
(function () {
  ...
  function ensureLayout() {
    ...
    const contentNodes =
      Array.from(body.childNodes).filter(function (node) {
        return !scripts.includes(node);
      });
    ...
    pageContent.appendChild(legacy);
  ...
  function getPageTitle() {
    ...
    const titles = {
      ...
      "admin.html": "Administrasi",
      "siswa.html": "Data Siswa",
      "guru.html": "Data Guru",
      "kelas.html": "Data Kelas",
      "presensi.html": "Presensi Siswa",
      "scan.html": "Scan QR",
      "kartu.html": "Kartu Siswa",
      "absen-bulanan.html": "Laporan Bulanan",
      "pengaturan.html": "Pengaturan"
    };

    return titles[page] || "Presensi Sekolah";
  }
